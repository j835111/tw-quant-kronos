...
- 凍結 Kronos + XGBoost LambdaRankIC 初版（Round 6 / M1）：Sharpe 0.34，主因 regime 依賴（見下）
...
| cs_rank + 多尺度動能特徵（B+C）+ `rank_ic` 早停 + 2021 動能 regime 驗證窗口 | round6-improvements Batch 3c | Batch 3c | ✅ 測試期 IC/top-10 excess 大幅改善，真實回測 Sharpe 1.336，刷新當時紀錄 |
